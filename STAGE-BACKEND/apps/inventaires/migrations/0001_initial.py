    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entite_type', models.CharField(choices=[('DEPARTEMENT', 'Département'), ('DIRECTION', 'Direction'), ('SERVICE', 'Service'), ('MAGASIN', 'Magasin')], max_length=20)),
                ('entite_id', models.PositiveIntegerField()),
                ('type_inventaire', models.CharField(choices=[('GENERAL', 'Général'), ('PARTIEL', 'Partiel'), ('PERIODIQUE', 'Périodique'), ('EXCEPTIONNEL', 'Exceptionnel')], default='GENERAL', max_length=20)),
