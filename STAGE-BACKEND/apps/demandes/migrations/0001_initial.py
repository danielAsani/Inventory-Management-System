    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origine_type', models.CharField(choices=[('DEPARTEMENT', 'Département'), ('DIRECTION', 'Direction'), ('SERVICE', 'Service'), ('MAGASIN', 'Magasin')], default='DEPARTEMENT', max_length=20)),
                ('origine_id', models.PositiveIntegerField(blank=True, null=True)),
                ('type_demande', models.CharField(choices=[('ACHAT', 'Achat'), ('REAPPROVISIONNEMENT', 'Réapprovisionnement'), ('REPARATION', 'Réparation'), ('AUTRE', 'AUTRE')], max_length=30)),
                ('statut', models.CharField(choices=[('EN_ATTENTE', 'En attente'), ('VALIDEE', 'Validée'), ('REJETEE', 'Rejetée'), ('TRAITEE', 'Traitée'), ('ANNULEE', 'Annulée')], default='EN_ATTENTE', max_length=20)),
