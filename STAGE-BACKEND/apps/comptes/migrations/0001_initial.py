    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scope_type', models.CharField(choices=[('GENERAL', 'Général'), ('DEPARTEMENT', 'Département'), ('DIRECTION', 'Direction'), ('SERVICE', 'Service'), ('MAGASIN', 'Magasin')], default='GENERAL', max_length=20)),
